...
<body>
   ...
   <div class="customer-info-container">
       ...
       <ul>
           <li>Total:
           <span class="total">
           <fmt:formatNumber value="${orderInfo.amount}" type="currency" currencySymbol="INR."/>
           </span></li>
       </ul>
   </div>
   ...
   <table border="1" style="width:100%">
       ...
       <c:forEach items="${orderInfo.details}" var="orderDetailInfo">
           <tr>
               ...
               <td>
                <fmt:formatNumber value="${orderDetailInfo.price}" type="currency" currencySymbol="INR."/>
               </td>
               <td>
                <fmt:formatNumber value="${orderDetailInfo.amount}" type="currency" currencySymbol="INR."/>
               </td>
           </tr>
       </c:forEach>
   </table>
